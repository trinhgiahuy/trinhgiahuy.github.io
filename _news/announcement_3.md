...
<div class="row">
  <div class="col-md-6">
    ...
    <audio controls preload="none" style="width:100%;">
      <source src="{{ '/assets/audio/bosonai_hackathon/q7_caller.mp3' | relative_url }}" type="audio/mpeg">
    </audio>
  </div>
  ...
  <div class="col-md-6">
    ...
    <p><strong>Agent</strong>: short phrase answer</p>
    <audio controls preload="none" style="width:100%;">
      <source src="{{ '/assets/audio/bosonai_hackathon/q7_agent.mp3' | relative_url }}" type="audio/mpeg">
    </audio>
  </div>
</div>
...
<div class="row">
  <div class="col-md-4">
    ...
    <audio controls preload="none" style="width:100%;">
      <source src="{{ '/assets/audio/bosonai_hackathon/example0.mp3' | relative_url }}" type="audio/mpeg">
    </audio>
  </div>
  ...
  <div class="col-md-4">
    ...
    <audio controls preload="none" style="width:100%;">
      <source src="{{ '/assets/audio/bosonai_hackathon/example35.mp3' | relative_url }}" type="audio/mpeg">
    </audio>
  </div>
  ...
  <div class="col-md-4">
    ...
    <audio controls preload="none" style="width:100%;">
      <source src="{{ '/assets/audio/bosonai_hackathon/example56.mp3' | relative_url }}" type="audio/mpeg">
    </audio>
  </div>
</div>
...
<div class="row">
  <div class="col-md-12">
    {% include figure.html
      path="assets/img/posts/bosonai_hackathon/slide_07_confusion.png"
      class="img-fluid rounded z-depth-1"
      alt="Department and intent confusion matrices"
      caption="Confusion matrices (department / intent)."
    %}
  </div>
</div>
